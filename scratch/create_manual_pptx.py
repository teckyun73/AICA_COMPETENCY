...
def main():
    ...
    add_two_column_slide(
        ...
        [
            ...
            "\n💡 대시보드 우측 상단 배지를 통해 시연용 가상 데이터 복원 및 실무용 초기화를 손쉽게 제어할 수 있습니다.",
    ...
    # =========================================================================
    # SLIDE 5.5: Monthly Calendar & Date Metadata (공통 - 월별 심사 일정과 산출물 날짜 표기)
    # =========================================================================
    slide5_5 = prs.slides.add_slide(blank_layout)
    set_bg(slide5_5)
    add_two_column_slide(
        slide5_5,
        "월별 자격심사 일정과 산출물 날짜가 명확히 연동됩니다",
        "월별 캘린더 연동 및 평가 산출물 일자 표기",
        [
            "1. 로그인 초기화면 월별 캘린더:",
            "• 운영간사 및 심사위원 로그인 시 메인 화면에 캘린더가 렌더링됩니다.",
            "• 심사일자에 [AICA L3 심사], [AICA L4 심사] 명칭으로 일정이 자동 기입됩니다.",
            "\n2. 일정 클릭 시 화면 자동 이동:",
            "• 캘린더 내 심사 일정을 클릭하면 운영간사는 대시보드/종합판정서로, 심사위원은 해당 배정 과제 평가 화면으로 즉시 이동합니다.",
            "\n3. 평가 산출물 명확한 날짜 표기:",
            "• 종합판정서: 심사 시행 일자, 과제 제출 일시, 최종 승인 일시, 위원별 채점 제출 일시, 판정서 발행 일자 명시",
            "• 평가 워크스페이스: 과제 제출일 및 심사 시행 예정일 실시간 상단 노출",
            "\n오른쪽 화면: 실제 리액트 월별 캘린더 및 종합판정서 렌더링 화면"
        ],
        "media__1784188798650.png",
        "공통",
        "05-B"
